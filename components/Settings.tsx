          ...
          {activeTab === 'security' && (
            <div className="space-y-8 animate-in fade-in duration-300">
              ...
              <div className="pt-6 border-t border-red-100 dark:border-red-900/50">
                ...
                {showDeleteConfirm && (
                   <div className="mt-4 p-4 bg-white dark:bg-slate-800 border border-red-200 dark:border-red-700 rounded-xl animate-in zoom-in shadow-lg">
                      <p className="font-bold text-slate-800 dark:text-white mb-2">Êtes-vous absolument sûr ?</p>
                      <p className="text-sm text-slate-600 dark:text-slate-400 mb-4">
                        Cette action supprimera définitivement votre profil, votre portefeuille VXT et tout votre historique.
                      </p>
                      
                      <div className="mb-4">
                        <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">
                          Veuillez taper <span className="font-bold select-all">SUPPRIMER</span> pour confirmer :
                        </label>
                        <input
                          type="text"
                          ...
                          className="w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-red-500 focus:border-red-500 dark:bg-slate-700 dark:text-white font-mono text-sm"
                        />
                      </div>
                      ...
                      <div className="flex gap-3">
                         ...
                         <button 
                            ...
                            className="flex-1 px-4 py-2 bg-red-600 text-white rounded-lg font-bold hover:bg-red-700 flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                         >
